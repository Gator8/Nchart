...
class Nest:
    ...
    def show_status(self):
        ...
        # this prints a neat list. what is needed is a sql statement to insert into a mysql db
        for k in sorted(allvars.keys()):
             #print k + "."*(32-len(k)) + ":", allvars[k]
          print k + ":", allvars[k]
        # this is mac address. Used as table name.
        #madd = self.status["shared"][self.serial]["mac_address"]
        #print madd
        #sqlstring = "INSERT INTO " + self.status["shared"][self.serial]["name"]
        #print sqlstring
